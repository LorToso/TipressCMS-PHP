...
class NewsTableMap extends TableMap
{
     ...
     */
    const COL_TITOLO = 'news.titolo';

    /**
     * the column name for the testo_breve field
     */
    const COL_TESTO_BREVE = 'news.testo_breve';

    /**
     * the column name for the testo field
     */
    const COL_TESTO = 'news.testo';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Titolo', 'TestoBreve', 'Testo', ),
        self::TYPE_CAMELNAME     => array('id', 'titolo', 'testoBreve', 'testo', ),
        self::TYPE_COLNAME       => array(NewsTableMap::COL_ID, NewsTableMap::COL_TITOLO, NewsTableMap::COL_TESTO_BREVE, NewsTableMap::COL_TESTO, ),
        self::TYPE_FIELDNAME     => array('ID', 'titolo', 'testo_breve', 'testo', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Titolo' => 1, 'TestoBreve' => 2, 'Testo' => 3, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'titolo' => 1, 'testoBreve' => 2, 'testo' => 3, ),
        self::TYPE_COLNAME       => array(NewsTableMap::COL_ID => 0, NewsTableMap::COL_TITOLO => 1, NewsTableMap::COL_TESTO_BREVE => 2, NewsTableMap::COL_TESTO => 3, ),
        self::TYPE_FIELDNAME     => array('ID' => 0, 'titolo' => 1, 'testo_breve' => 2, 'testo' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('titolo', 'Titolo', 'VARCHAR', true, 200, null);
        $this->addColumn('testo_breve', 'TestoBreve', 'CLOB', true, null, null);
        $this->addColumn('testo', 'Testo', 'CLOB', true, null, null);
    } // initialize()
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(NewsTableMap::COL_TITOLO);
            $criteria->addSelectColumn(NewsTableMap::COL_TESTO_BREVE);
            $criteria->addSelectColumn(NewsTableMap::COL_TESTO);
        } else {
            $criteria->addSelectColumn($alias . '.ID');
            $criteria->addSelectColumn($alias . '.titolo');
            $criteria->addSelectColumn($alias . '.testo_breve');
