...
class ClientiTableMap extends TableMap
{
     ...
     */
    const COL_ID = 'clienti.ID';

    /**
     * the column name for the cognome field
     */
    const COL_COGNOME = 'clienti.cognome';

    /**
     * the column name for the nome field
     */
    const COL_NOME = 'clienti.nome';

    /**
     * the column name for the descrizione field
     */
    const COL_DESCRIZIONE = 'clienti.descrizione';

    /**
     * the column name for the img_small field
     */
    const COL_IMG_SMALL = 'clienti.img_small';

    /**
     * the column name for the img_big field
     */
    const COL_IMG_BIG = 'clienti.img_big';

    /**
     * the column name for the sito field
     */
    const COL_SITO = 'clienti.sito';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Cognome', 'Nome', 'Descrizione', 'ImgSmall', 'ImgBig', 'Sito', ),
        self::TYPE_CAMELNAME     => array('id', 'cognome', 'nome', 'descrizione', 'imgSmall', 'imgBig', 'sito', ),
        self::TYPE_COLNAME       => array(ClientiTableMap::COL_ID, ClientiTableMap::COL_COGNOME, ClientiTableMap::COL_NOME, ClientiTableMap::COL_DESCRIZIONE, ClientiTableMap::COL_IMG_SMALL, ClientiTableMap::COL_IMG_BIG, ClientiTableMap::COL_SITO, ),
        self::TYPE_FIELDNAME     => array('ID', 'cognome', 'nome', 'descrizione', 'img_small', 'img_big', 'sito', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Cognome' => 1, 'Nome' => 2, 'Descrizione' => 3, 'ImgSmall' => 4, 'ImgBig' => 5, 'Sito' => 6, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'cognome' => 1, 'nome' => 2, 'descrizione' => 3, 'imgSmall' => 4, 'imgBig' => 5, 'sito' => 6, ),
        self::TYPE_COLNAME       => array(ClientiTableMap::COL_ID => 0, ClientiTableMap::COL_COGNOME => 1, ClientiTableMap::COL_NOME => 2, ClientiTableMap::COL_DESCRIZIONE => 3, ClientiTableMap::COL_IMG_SMALL => 4, ClientiTableMap::COL_IMG_BIG => 5, ClientiTableMap::COL_SITO => 6, ),
        self::TYPE_FIELDNAME     => array('ID' => 0, 'cognome' => 1, 'nome' => 2, 'descrizione' => 3, 'img_small' => 4, 'img_big' => 5, 'sito' => 6, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, )
    );
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(ClientiTableMap::COL_ID);
            $criteria->addSelectColumn(ClientiTableMap::COL_COGNOME);
            $criteria->addSelectColumn(ClientiTableMap::COL_NOME);
            $criteria->addSelectColumn(ClientiTableMap::COL_DESCRIZIONE);
            $criteria->addSelectColumn(ClientiTableMap::COL_IMG_SMALL);
            $criteria->addSelectColumn(ClientiTableMap::COL_IMG_BIG);
            $criteria->addSelectColumn(ClientiTableMap::COL_SITO);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(ClientiTableMap::COL_ID, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(ClientiTableMap::COL_ID) && $criteria->keyContainsValue(ClientiTableMap::COL_ID) ) {
