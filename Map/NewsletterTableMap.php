...
class NewsletterTableMap extends TableMap
{
     ...
     */
    const COL_TITOLO = 'newsletter.titolo';

    /**
     * the column name for the testo field
     */
    const COL_TESTO = 'newsletter.testo';

    /**
     * the column name for the lingua field
     */
    const COL_LINGUA = 'newsletter.lingua';

    /**
     * the column name for the tipologia field
     */
    const COL_TIPOLOGIA = 'newsletter.tipologia';

    /**
     * the column name for the datains field
     */
    const COL_DATAINS = 'newsletter.datains';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Titolo', 'Testo', 'Lingua', 'Tipologia', 'Datains', ),
        self::TYPE_CAMELNAME     => array('id', 'titolo', 'testo', 'lingua', 'tipologia', 'datains', ),
        self::TYPE_COLNAME       => array(NewsletterTableMap::COL_ID, NewsletterTableMap::COL_TITOLO, NewsletterTableMap::COL_TESTO, NewsletterTableMap::COL_LINGUA, NewsletterTableMap::COL_TIPOLOGIA, NewsletterTableMap::COL_DATAINS, ),
        self::TYPE_FIELDNAME     => array('ID', 'titolo', 'testo', 'lingua', 'tipologia', 'datains', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Titolo' => 1, 'Testo' => 2, 'Lingua' => 3, 'Tipologia' => 4, 'Datains' => 5, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'titolo' => 1, 'testo' => 2, 'lingua' => 3, 'tipologia' => 4, 'datains' => 5, ),
        self::TYPE_COLNAME       => array(NewsletterTableMap::COL_ID => 0, NewsletterTableMap::COL_TITOLO => 1, NewsletterTableMap::COL_TESTO => 2, NewsletterTableMap::COL_LINGUA => 3, NewsletterTableMap::COL_TIPOLOGIA => 4, NewsletterTableMap::COL_DATAINS => 5, ),
        self::TYPE_FIELDNAME     => array('ID' => 0, 'titolo' => 1, 'testo' => 2, 'lingua' => 3, 'tipologia' => 4, 'datains' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('datains', 'Datains', 'TIMESTAMP', false, null, '0000-00-00 00:00:00');
    } // initialize()
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(NewsletterTableMap::COL_TITOLO);
            $criteria->addSelectColumn(NewsletterTableMap::COL_TESTO);
            $criteria->addSelectColumn(NewsletterTableMap::COL_LINGUA);
            $criteria->addSelectColumn(NewsletterTableMap::COL_TIPOLOGIA);
            $criteria->addSelectColumn(NewsletterTableMap::COL_DATAINS);
        } else {
            ...
            $criteria->addSelectColumn($alias . '.datains');
        }
    }
     ...
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            foreach ((array) $values as $singleval) {
                NewsletterTableMap::removeInstanceFromPool($singleval);
            }
        }
