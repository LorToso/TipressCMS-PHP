...
abstract class Clienti implements ActiveRecordInterface
{
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[ClientiTableMap::COL_ID] = true;
        }
    ...
    public function setCognome($v)
    {
        ...
        if ($this->cognome !== $v) {
            $this->cognome = $v;
            $this->modifiedColumns[ClientiTableMap::COL_COGNOME] = true;
        }
    ...
    public function setNome($v)
    {
        ...
        if ($this->nome !== $v) {
            $this->nome = $v;
            $this->modifiedColumns[ClientiTableMap::COL_NOME] = true;
        }
    ...
    public function setDescrizione($v)
    {
        ...
        if ($this->descrizione !== $v) {
            $this->descrizione = $v;
            $this->modifiedColumns[ClientiTableMap::COL_DESCRIZIONE] = true;
        }
    ...
    public function setImgSmall($v)
    {
        ...
        if ($this->img_small !== $v) {
            $this->img_small = $v;
            $this->modifiedColumns[ClientiTableMap::COL_IMG_SMALL] = true;
        }
    ...
    public function setImgBig($v)
    {
        ...
        if ($this->img_big !== $v) {
            $this->img_big = $v;
            $this->modifiedColumns[ClientiTableMap::COL_IMG_BIG] = true;
        }
    ...
    public function setSito($v)
    {
        ...
        if ($this->sito !== $v) {
            $this->sito = $v;
            $this->modifiedColumns[ClientiTableMap::COL_SITO] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ClientiTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ClientiTableMap::translateFieldName('Cognome', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cognome = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ClientiTableMap::translateFieldName('Nome', TableMap::TYPE_PHPNAME, $indexType)];
            $this->nome = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ClientiTableMap::translateFieldName('Descrizione', TableMap::TYPE_PHPNAME, $indexType)];
            $this->descrizione = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : ClientiTableMap::translateFieldName('ImgSmall', TableMap::TYPE_PHPNAME, $indexType)];
            $this->img_small = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : ClientiTableMap::translateFieldName('ImgBig', TableMap::TYPE_PHPNAME, $indexType)];
            $this->img_big = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : ClientiTableMap::translateFieldName('Sito', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 7; // 7 = ClientiTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[ClientiTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . ClientiTableMap::COL_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(ClientiTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'ID';
        }
        if ($this->isColumnModified(ClientiTableMap::COL_COGNOME)) {
            $modifiedColumns[':p' . $index++]  = 'cognome';
        }
        if ($this->isColumnModified(ClientiTableMap::COL_NOME)) {
            $modifiedColumns[':p' . $index++]  = 'nome';
        }
        if ($this->isColumnModified(ClientiTableMap::COL_DESCRIZIONE)) {
            $modifiedColumns[':p' . $index++]  = 'descrizione';
        }
        if ($this->isColumnModified(ClientiTableMap::COL_IMG_SMALL)) {
            $modifiedColumns[':p' . $index++]  = 'img_small';
        }
        if ($this->isColumnModified(ClientiTableMap::COL_IMG_BIG)) {
            $modifiedColumns[':p' . $index++]  = 'img_big';
        }
        if ($this->isColumnModified(ClientiTableMap::COL_SITO)) {
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        $result = array(
            ...
            $keys[4] => $this->getImgSmall(),
            $keys[5] => $this->getImgBig(),
            $keys[6] => $this->getSito(),
        );
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) {
            $this->setDescrizione($arr[$keys[3]]);
        }
        if (array_key_exists($keys[4], $arr)) {
            $this->setImgSmall($arr[$keys[4]]);
        }
        if (array_key_exists($keys[5], $arr)) {
            $this->setImgBig($arr[$keys[5]]);
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ClientiTableMap::COL_ID)) {
            $criteria->add(ClientiTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(ClientiTableMap::COL_COGNOME)) {
            $criteria->add(ClientiTableMap::COL_COGNOME, $this->cognome);
        }
        if ($this->isColumnModified(ClientiTableMap::COL_NOME)) {
            $criteria->add(ClientiTableMap::COL_NOME, $this->nome);
        }
        if ($this->isColumnModified(ClientiTableMap::COL_DESCRIZIONE)) {
            $criteria->add(ClientiTableMap::COL_DESCRIZIONE, $this->descrizione);
        }
        if ($this->isColumnModified(ClientiTableMap::COL_IMG_SMALL)) {
            $criteria->add(ClientiTableMap::COL_IMG_SMALL, $this->img_small);
        }
        if ($this->isColumnModified(ClientiTableMap::COL_IMG_BIG)) {
            $criteria->add(ClientiTableMap::COL_IMG_BIG, $this->img_big);
        }
        if ($this->isColumnModified(ClientiTableMap::COL_SITO)) {
            $criteria->add(ClientiTableMap::COL_SITO, $this->sito);
        }
