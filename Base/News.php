...
abstract class News implements ActiveRecordInterface
{
    ...
    /**
     * The value for the testo_breve field.
     *
     * @var        string
     */
    protected $testo_breve;
    ...
    /**
     * Get the [testo_breve] column value.
     *
     * @return string
     */
    ...
    public function setTitolo($v)
    {
        ...
        if ($this->titolo !== $v) {
            $this->titolo = $v;
            $this->modifiedColumns[NewsTableMap::COL_TITOLO] = true;
        }
    ...
    /**
     * Set the value of [testo_breve] column.
     *
     * @param string $v new value
     * @return $this|\News The current object (for fluent API support)
     */
    public function setTestoBreve($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->testo_breve !== $v) {
            $this->testo_breve = $v;
            $this->modifiedColumns[NewsTableMap::COL_TESTO_BREVE] = true;
        }
    ...
    public function setTesto($v)
    {
        ...
        if ($this->testo !== $v) {
            $this->testo = $v;
            $this->modifiedColumns[NewsTableMap::COL_TESTO] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : NewsTableMap::translateFieldName('Titolo', TableMap::TYPE_PHPNAME, $indexType)];
            $this->titolo = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : NewsTableMap::translateFieldName('TestoBreve', TableMap::TYPE_PHPNAME, $indexType)];
            $this->testo_breve = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : NewsTableMap::translateFieldName('Testo', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 4; // 4 = NewsTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(NewsTableMap::COL_TITOLO)) {
            $modifiedColumns[':p' . $index++]  = 'titolo';
        }
        if ($this->isColumnModified(NewsTableMap::COL_TESTO_BREVE)) {
            $modifiedColumns[':p' . $index++]  = 'testo_breve';
        }
        if ($this->isColumnModified(NewsTableMap::COL_TESTO)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'titolo':
                        ...
                        break;
                    case 'testo_breve':
                        $stmt->bindValue($identifier, $this->testo_breve, PDO::PARAM_STR);
                        break;
                    case 'testo':
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(NewsTableMap::COL_TITOLO)) {
            $criteria->add(NewsTableMap::COL_TITOLO, $this->titolo);
        }
        if ($this->isColumnModified(NewsTableMap::COL_TESTO_BREVE)) {
            $criteria->add(NewsTableMap::COL_TESTO_BREVE, $this->testo_breve);
        }
        if ($this->isColumnModified(NewsTableMap::COL_TESTO)) {
            $criteria->add(NewsTableMap::COL_TESTO, $this->testo);
        }
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setTestoBreve($this->getTestoBreve());
